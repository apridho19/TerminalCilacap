...
<body class="fixed-navbar">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button"
                                                ...
                                                onclick="editData({{ $data->id }}, '{{ $data->no_kendaraan }}', '{{ $data->nama_po }}', '{{ $data->jenis_trayek }}', '{{ $data->asal_tujuan }}', '{{ $data->data_trayek }}', '{{ $data->provinsi }}', '{{ $data->terminal_tujuan }}', '{{ $data->kabupaten }}')"
                                                data-toggle="tooltip"
                                                title="Edit Data"
    ...
    <script>
        ...
        function editData(id, no_kendaraan, nama_po, jenis_trayek, asal_tujuan, data_trayek, provinsi, terminal_tujuan, kabupaten) {
            // Set form action
        ...
        function confirmDelete(id, noKendaraan) {
            Swal.fire({
                title: 'Hapus Data?',
                html: `Apakah Anda yakin ingin menghapus data:<br><strong>${noKendaraan}</strong>?<br><br><small class="text-muted">Data yang dihapus tidak dapat dikembalikan</small>`,
                icon: 'warning',
        ...
        // Event listener untuk button hapus duplikat
        document.getElementById('btnRemoveDuplicates').addEventListener('click', function() {
            Swal.fire({
                ...
                html: 'Sistem akan mencari dan menghapus data dengan <strong>No Kendaraan yang sama</strong>.<br><br>' +
                    '<small class="text-muted">Data terlama akan dipertahankan, data duplikat lainnya akan dihapus.</small><br>' +
