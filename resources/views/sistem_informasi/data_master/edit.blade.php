...
<div class="page-wrapper">
    <div class="content-wrapper">
        ...
        <div class="page-heading">
            <h1 class="page-title">Edit Data Master</h1>
            <ol class="breadcrumb">
        ...
        <div class="page-content fade-in-up">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Form Edit Data Master</div>
                </div>
                <div class="ibox-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('datamaster.update', $dataMaster->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('no_kendaraan') is-invalid @enderror"
                                        ...
                                        value="{{ old('no_kendaraan', $dataMaster->no_kendaraan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama_po') is-invalid @enderror"
                                        ...
                                        value="{{ old('nama_po', $dataMaster->nama_po) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('jenis_trayek') is-invalid @enderror"
                                        ...
                                        <option value="AKAP" {{ old('jenis_trayek', $dataMaster->jenis_trayek) == 'AKAP' ? 'selected' : '' }}>AKAP</option>
                                        <option value="AKDP" {{ old('jenis_trayek', $dataMaster->jenis_trayek) == 'AKDP' ? 'selected' : '' }}>AKDP</option>
                                    </select>
                                    @error('jenis_trayek')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('asal_tujuan') is-invalid @enderror"
                                        ...
                                        value="{{ old('asal_tujuan', $dataMaster->asal_tujuan) }}"
                                        maxlength="100">
                                    @error('asal_tujuan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('data_trayek') is-invalid @enderror"
                                ...
                                rows="3" maxlength="255">{{ old('data_trayek', $dataMaster->data_trayek) }}</textarea>
                            @error('data_trayek')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('provinsi') is-invalid @enderror"
                                        ...
                                        value="{{ old('provinsi', $dataMaster->provinsi) }}"
                                        maxlength="50">
                                    @error('provinsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('kabupaten') is-invalid @enderror"
                                        ...
                                        value="{{ old('kabupaten', $dataMaster->kabupaten) }}"
                                        maxlength="50">
                                    @error('kabupaten')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('terminal_tujuan') is-invalid @enderror"
                                        ...
                                        value="{{ old('terminal_tujuan', $dataMaster->terminal_tujuan) }}"
                                        maxlength="50">
