        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    <h4 class="text-warning mb-4">Info Kontak</h4>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a class="btn mx-1" href=""><i class="fab fa-whatsapp"></i></a>
                        <a class="btn mx-1" href="{{ url('https://www.instagram.com/tta_bmdcilacap/') }}"><i class="fab fa-instagram"></i></a>
                        <a class="btn mx-1" href="{{ url('https://www.youtube.com/@tta_bmdcilacap') }}"><i class="fab fa-youtube"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    <h4 class="text-warning mb-4">Opening Time</h4>
                    <div class="mb-3">
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-white"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>Terminal BMD
                        Cilacap</a>, All right reserved.</span>
            </div>
