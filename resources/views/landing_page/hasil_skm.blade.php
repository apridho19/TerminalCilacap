                            ...
                            <div class="service-inner">
                                ...
                                <div class="service-title">
                                    <div class="service-title-name">
                                        ...
                                        <a class="btn bg-light text-warning rounded-pill py-3 px-5 mb-4" href="#">Explore More</a>
                                    </div>
                                    <div class="service-content pb-4">
                                        ...
                                        <div class="px-4">
                                            ...
                                            <a class="btn btn-primary border-warning rounded-pill py-3 px-5" href="#">Explore More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="service-inner">
                                ...
                                <div class="service-title">
                                    ...
                                    <div class="service-content pb-4">
                                        ...
                                        <div class="px-4">
                                            <p class="mb-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia fugit dolores nesciunt adipisci obcaecati veritatis cum, ratione aspernatur autem velit.</p>
                                            <a class="btn btn-primary border-warning rounded-pill text-white py-3 px-5" href="#">Explore More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="counter">
                            ...
                            <div class="counter-content">
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <h4 class="text-warning mb-0" style="font-weight: 600; font-size: 25px;">+</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="counter">
                            ...
                            <div class="counter-content">
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <h4 class="text-warning mb-0" style="font-weight: 600; font-size: 25px;">K</h4>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid country overflow-hidden py-5">
            <div class="container py-5">
                ...
                <div class="row g-4 text-center">
                    ...
                    <div class="col-12">
                        <a class="btn btn-primary border-warning rounded-pill py-3 px-5 wow fadeInUp" data-wow-delay="0.1s" href="#">More Countries</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="training-item">
                            ...
                            <div class="training-content bg-warning rounded-bottom p-4">
                                ...
                                <a class="btn btn-warning rounded-pill text-white p-0" href="#">Read More <i class="fa fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 text-center">
                        <a class="btn btn-primary border-warning rounded-pill py-3 px-5 wow fadeInUp" data-wow-delay="0.1s" href="#">View More</a>
                    </div>
                </div>
            </div>
        </div>
